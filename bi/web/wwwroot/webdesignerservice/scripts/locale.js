    ...
    App: {
		...
		oauthDriveButtonLable: "Select a file from the drive",
			...
			boldbiaiassistant: {
				...
				activationSuccess1: "Your activation was successful! Please refresh the license on the ",
				activationSuccess2: " Manage License page to apply it to this instance.",
				...
				activateContent1: "Activating the AI Assistant means your conversations may be recorded for up to 90 days to improve service.",
